...
int main(void)
{
  ...
  /* creation of RosSerialTask */
  RosSerialTaskHandle = osThreadNew(StartRosSerialTask, NULL, &RosSerialTask_attributes);
...
__weak void StartRosSerialTask(void *argument)
{
