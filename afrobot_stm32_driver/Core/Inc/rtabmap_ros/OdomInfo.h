...
namespace rtabmap_ros
{
  ...
  class OdomInfo : public ros::Msg
  {
    public:
      ...
      typedef rtabmap_ros::CameraModels _localBundleModels_type;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      if(localBundleModels_lengthT > localBundleModels_length)
        this->localBundleModels = (rtabmap_ros::CameraModels*)realloc(this->localBundleModels, localBundleModels_lengthT * sizeof(rtabmap_ros::CameraModels));
      localBundleModels_length = localBundleModels_lengthT;
      for( uint32_t i = 0; i < localBundleModels_length; i++){
      offset += this->st_localBundleModels.deserialize(inbuffer + offset);
        memcpy( &(this->localBundleModels[i]), &(this->st_localBundleModels), sizeof(rtabmap_ros::CameraModels));
      }
    ...
    const char * getMD5(){ return "52076ef68d0b87422f3983864c204b62"; };
