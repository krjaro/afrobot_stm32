  ...
  class Info : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 3) = (u_proximityDetectionId.base >> (8 * 3)) & 0xFF;
      ...
      u_landmarkId.real = this->landmarkId;
      *(outbuffer + offset + 0) = (u_landmarkId.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_landmarkId.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_landmarkId.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_landmarkId.base >> (8 * 3)) & 0xFF;
      offset += sizeof(this->landmarkId);
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      u_landmarkId.base = 0;
      u_landmarkId.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_landmarkId.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_landmarkId.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_landmarkId.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      this->landmarkId = u_landmarkId.real;
      offset += sizeof(this->landmarkId);
    ...
    const char * getMD5(){ return "656fb5b8dfd8dfd2dc40226f35f2d440"; };
