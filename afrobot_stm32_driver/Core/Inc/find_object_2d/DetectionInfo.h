...
namespace find_object_2d
{
  ...
  class DetectionInfo : public ros::Msg
  {
    ...
    DetectionInfo():
      ...
      widths_length(0), widths(NULL),
      heights_length(0), heights(NULL),
      filePaths_length(0), filePaths(NULL),
      inliers_length(0), inliers(NULL),
      outliers_length(0), outliers(NULL),
      homographies_length(0), homographies(NULL)
    {
    }
    ...
    const char * getType(){ return "find_object_2d/DetectionInfo"; };
    const char * getMD5(){ return "c344e94bd36ff0758e87d95453ebd0bd"; };
